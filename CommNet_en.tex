...
In case of \textbf{SpaceX Starlink}, it's satellites only stay in orbit for as long they still have fuel in their tanks. That makes maintenance of those networks a little bit more difficult, but you have the certainty that any defect satellites will deorbit automaticly after 5 years and that no space debree will ever be left behind.
Unlike other satellite providers who also use ion thruster, SpaceX decided to use Krypton as reaction mass instead of Xenon, which is more usual. Another name you may find is Hall-effect thruster (HET).
...
For spacecrafts this factor is usually very low, because every millimeter that you add to the thickness of a tank wall, will probably add many kilos or even tons of extra weight, which in turn requires a stronger engine and more fuel...which adds more weight...wich reduces the payload mass that the rocket can bring with it into space.\\
